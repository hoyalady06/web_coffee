...
const menu = [
  {
    title: "",
    items: [{ href: "/manager/dashboard", label: "Dashboard" }],
  },
  {
    title: "Управление",
    items: [
      { href: "/manager/orders", label: "Заказы" },
      { href: "/manager/returns", label: "Возвраты" },
      { href: "/manager/career", label: "Карьера" },
      { href: "/manager/contacts", label: "Контакты" },
    ],
  },
];
